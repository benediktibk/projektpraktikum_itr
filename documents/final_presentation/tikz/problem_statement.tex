...
\begin{tikzpicture}
	...
	\draw[->,thick,dashed,red] (3, 3.75) -- (3.7, 2);
	
	\node[text=red] at (3.57, 1.7) {CoM};	
	\node[text=red] at (3.8, 2.75) {$\vec{c}$};
	\draw[->,thick,dashed] (3, 3.75) -- (5.15, 2.7);
	\draw[->,thick,dashed] (3, 3.75) -- (3.1, 0.55);
	\node at (2.5, 2.2) {$\vec{r}_{\mathrm{R}\rightarrow\mathrm{H}^1}$};
	\node at (4.5, 3.4) {$\vec{r}_{\mathrm{R}\rightarrow\mathrm{H}^2}$};
	% grasping offsets
