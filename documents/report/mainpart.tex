...
\begin{figure}
	...
	\psfrag{yaxis}[br][tr]{$F\left[\scr{N}\right]$}
	\psfrag{one}[c][Br]{$0$}
	\psfrag{two}[c][Br]{$1$}
	\psfrag{thr}[c][Br]{$2$}
	\psfrag{fou}[c][Br]{$3$}
	\psfrag{fiv}[c][Br]{$4$}
	\psfrag{six}[c][Br]{$5$}
	\psfrag{lllllllll}[Br][Bl]{$-100\  $}
	\psfrag{lllllllli}[Br][Bl]{$-50\  $}
	\psfrag{lllllllil}[Br][Bl]{$0\  $}
	\psfrag{lllllllii}[Br][Bl]{$50\  $}
	\psfrag{llllllill}[br][Bl]{$100\  $}
...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption{Estimation error of mass $m \left[\mathrm{kg}\right]$ and center of mass $\vec{c}$ with one grasping point}
...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption{Inertia Tensor error $I \left[\mathrm{kg} \cdot \mathrm{m}^2\right]$ with one grasping point}
...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption{Estimation error of mass $m \left[\mathrm{kg}\right]$ and center of mass $\vec{c}$ with one grasping point and noise on $\vec F$ and $\vec M$}
...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption{Inertia Tensor error $I \left[\mathrm{kg} \cdot \mathrm{m}^2\right]$ with one grasping point and noise on $\vec F$ and $\vec M$}
...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption{Estimation error of mass $m \left[\mathrm{kg}\right]$ and center of mass $\vec{c}$ with three grasping points}
...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption{Inertia Tensor error $I \left[\mathrm{kg} \cdot \mathrm{m}^2\right]$ with three grasping points}
...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption{Estimation of mass $m$ and center of mass $\vec{c}$ with three grasping points and noise on $\vec F$ and $\vec M$}
...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption{Inertia Tensor error $I \left[\mathrm{kg} \cdot \mathrm{m}^2\right]$ with three grasping points and noise on $\vec F$ and $\vec M$}
...
In the simulation the recursive least squares converges in this case within seconds for one grasping point, as it can be seen in \ref{fig:mass_error}, \ref{fig:grasping_offset_error} and \ref{fig:inertia_error}
