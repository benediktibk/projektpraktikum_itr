...
The second step is then running the software, which is described detailed in the tutorial in the repository of the source code. Basically, there five are steps involved:
\begin{enumerate}
	...
	\item starting the force and torque measurement on ???
