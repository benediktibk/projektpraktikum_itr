...
\begin{itemize}
	\item TUM Robots 7 Joints + FT Sensor
	\item \textsc{Qualisys} Motion Tracking System
	\item Number of rigid bodies and their alignment
	\item Handles for humans equipped with FT sensor
	\item Vebrotactile bands 
\end{itemize}
...
\begin{itemize}
	\item \textsc{JR3}
	\item \textsc{Qualisys}
	\item Real-Time Operating System, SfBComm
	\item (Robot Joint Encoders -> EEF Position)
	\item Utilization of Feedfoward Signals (assumption of a very stiff, precise control)
\end{itemize}

\subsection{Data Processing}
\begin{itemize}
	\item \textsc{Qualisys} Real-Time sampling frequency
