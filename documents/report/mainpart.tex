...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption[Inertia Tensor error, three grasping points]{Inertia Tensor error $I \left[\mathrm{kg} \, \mathrm{m}^2\right]$ with three grasping points}
...
\begin{figure}
	...
	\vspace{0.2cm}
	\caption[Inertia Tensor error, three grasping points and noise]{Inertia Tensor error $I \left[\mathrm{kg} \,\mathrm{m}^2\right]$ with three grasping points and noise on $\vec F$ and $\vec M$}
