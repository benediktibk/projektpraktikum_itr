...
\centering
\sf
\psfrag{xaxis}[tr][br]{$\theta_0 \left[\mathrm{rad}\right]$}
\psfrag{yaxis}[br][tr]{$\frac{\omega}{\omega_0}$}
\psfrag{one}[c][Br]{$0$}
\psfrag{two}[c][Br]{$\frac{\pi}{4}$}
\psfrag{thr}[c][Br]{$\frac{\pi}{2}$}
\psfrag{fou}[c][Br]{$\frac{3\pi}{4}$}
\psfrag{fiv}[c][Br]{$\pi$}
\psfrag{lllllllll}[Br][Bl]{$0.2\  $}
\psfrag{llllllill}[Br][Bl]{$0.4\  $}
\psfrag{lllllilll}[Br][Bl]{$0.6\  $}
\psfrag{llllliill}[Br][Bl]{$0.8\  $}
\psfrag{llllillll}[br][Bl]{$1.0\  $}
\psfrag{asss}[bc][cl]{$\omega_{\mathrm{n}}$}
\psfrag{bsss}[bc][cl]{$\tilde{\omega}_{\mathrm{n}} $}

\includegraphics[width=0.8\textwidth]{untitled}
\vspace{0.2cm}
\caption[Natural frequency of simple pendulum.]{Natural frequency of simple pendulum}
\label{FIG:abb8}
\end{figure}
